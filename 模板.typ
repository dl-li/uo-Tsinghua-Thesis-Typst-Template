...
set page("a4",
    ...
    context [
      #set align(center)
      #set text(字号.五号, font: "Times New Roman")
...
[
  ...
  #[
    ...
    #set text(20pt, font: "Arial")
    #strong[#论文题目_英]
  ]

  #set align(bottom)
  #set text(字号.三号, font: "Times New Roman")
  ...
  *Tsinghua University*
  ...
  #text(font: "Arial")[*#英文学位名*] 
  
  in
  
  #text(font: "Arial")[*#专业_英*]
  
  \
  
  #text(font: "Arial")[by]

  #text(font: "Arial")[*#作者_英*]
  ...
  #v(25pt)
  #text(font: "Arial")[*#日期.display("[month repr:long], [year]")*]
  #v(4pt)
]
